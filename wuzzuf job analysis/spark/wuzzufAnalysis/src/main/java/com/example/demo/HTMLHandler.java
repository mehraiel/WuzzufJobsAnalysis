...
public class HTMLHandler {
    ...
    public static String HEADER_START = "<th style=\"width:100px;\">";
    ...
    public HTMLHandler(String func, Dataset<Row> data) {
        this.data= data;
    ...
    public HTMLHandler(String func, List<Row> data) {
        this.dataList= data;
        htmlBuilder.append(HTML_START);
        htmlBuilder.append(STYLE);
        htmlBuilder.append(HEAD_START);
    ...
    public HTMLHandler(String func)
    {
        htmlBuilder.append(HTML_START);
        htmlBuilder.append(STYLE);
        htmlBuilder.append(HEAD_START);
